...
- strona produktu ma galerie ze strzalkami, podglad zdjec po kliknieciu, zoom oraz obsluge `ArrowLeft`, `ArrowRight` i `Escape` w otwartym podgladzie,
